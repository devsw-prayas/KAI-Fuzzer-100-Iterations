...
block_0()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_13, reified T_14 : Throwable, reified T_23, T_25 : Runnable> fun_4(cond_2: Boolean, noinline block_4: () -> Unit): Unit {
...
class class_3<T_29 : sealed_0>(val value: T_29) {
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    inline fun <reified T_39 : Throwable> fun_15(block_9: () -> Unit, cond_4: Boolean, noinline block_12: () -> Unit): Unit {
