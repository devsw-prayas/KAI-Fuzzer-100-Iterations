...
val _catch_cls = T_14::class.java
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <T_11 : Runnable, reified T_12, reified T_17 : Throwable, T_21 : Runnable, T_26 : Comparable<T_26>, T_52 : Comparable<T_52>, reified T_74> fun_6(cond_1: Boolean, noinline block_3: () -> Unit, crossinline block_10: () -> Unit, noinline block_33: () -> Unit): Unit {
...
block_3()
    ...
    suspend fun <T_31 : Comparable<T_31>, T_41 : java.io.Serializable, T_75 : Runnable> fun_7(): Unit {
...
class class_3<T_29 : sealed_0>(val value: T_29) {
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    inline fun <reified T_39 : Throwable, reified T_44, T_48 : Runnable, reified T_76> fun_15(block_9: () -> Unit, cond_4: Boolean, noinline block_12: () -> Unit): Unit {
...
block_9()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_72 : Throwable> fun_19(noinline block_30: () -> Unit, cond_13: Boolean, noinline block_34: () -> Unit): Unit {
