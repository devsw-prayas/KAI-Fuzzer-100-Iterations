...
(false||false)
    ...
    operator fun <T_1 : Comparable<T_1>, T_4 : java.io.Serializable, T_6> minus(other: class_0<T_7>): Int {
                val var_3: () -> Int = {             try {
            } catch (e: IllegalArgumentException) {
            }
...
(0-51)
    ...
    inline fun <reified T_0 : Throwable, reified T_2, reified T_3, reified T_5> fun_3(block_0: () -> Unit, cond_0: Boolean, noinline block_1: () -> Unit): Unit {
