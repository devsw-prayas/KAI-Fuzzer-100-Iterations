class class_0<T_7 : Comparable<T_7>> {
    fun fun_0(): Unit {
                try {
            var var_0: Int = 100
            val var_1: () -> Int = {                 try {
...
(false||false)
    ...
    operator fun <T_1 : Comparable<T_1>, T_4 : java.io.Serializable, T_6, T_8 : java.io.Serializable, T_10 : java.io.Serializable, T_16 : Cloneable> minus(other: class_0<T_7>): Int {
                val var_3: () -> Int = {             try {
            } catch (e: IllegalArgumentException) {
            }
