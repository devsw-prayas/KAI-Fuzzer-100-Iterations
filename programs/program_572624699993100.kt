...
block_0()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_13, reified T_14 : Throwable, reified T_23, T_25 : Runnable, T_66 : Comparable<T_66>> fun_4(cond_2: Boolean, noinline block_4: () -> Unit, noinline block_15: () -> Unit, x_22: sealed_0): Unit {
...
inline fun <T_86, reified T_89, reified T_90 : Throwable> fun_5(x_20: sealed_0): Unit {
        try {
        val var_21: () -> Int = {             try {
