...
block_3()
    ...
    suspend inline fun <T_50 : Cloneable, reified T_64, reified T_65 : Throwable> fun_8(block_27: () -> Unit): Unit {
                try {
        } catch (e: RuntimeException) {
        }
                try {
...
@OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
inline fun <T_20, reified T_24, reified T_27, reified T_28 : Throwable, reified T_55> fun_2(cond_3: Boolean, noinline block_6: () -> Unit, noinline block_28: () -> Unit): Unit {
