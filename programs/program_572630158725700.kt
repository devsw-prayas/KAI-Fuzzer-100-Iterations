...
(0-51)
    ...
    inline fun <reified T_0 : Throwable, reified T_2, reified T_3, reified T_5, T_9 : Cloneable, reified T_15, reified T_22, reified T_59, reified T_63> fun_3(block_0: () -> Unit, cond_0: Boolean, noinline block_1: () -> Unit, crossinline block_2: () -> Unit, crossinline block_5: () -> Unit, noinline block_25: () -> Unit, noinline block_37: () -> Unit, x_15: sealed_0): Unit {
...
block_0()
        ...
        if (x_15 is sealed_0.class_1) return
                when (x_15) {
            is sealed_0.class_2 -> {
                Unit
            }
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_13, reified T_14 : Throwable, reified T_23, T_25 : Runnable, T_66 : Comparable<T_66>, T_93 : Comparable<T_93>> fun_4(cond_2: Boolean, noinline block_4: () -> Unit, noinline block_15: () -> Unit, x_22: sealed_0): Unit {
...
val _catch_cls = T_14::class.java
        ...
        block_4()
        if (x_22 is sealed_0.class_1) return
                when (x_22) {
            is sealed_0.class_2 -> {
                Unit
            }
...
block_27()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_78 : Throwable, T_79 : Comparable<T_79>> fun_14(noinline block_35: () -> Unit, cond_14: Boolean, noinline block_36: () -> Unit, x_19: sealed_0): Unit {
...
val _catch_cls = T_78::class.java
        ...
        if (x_19 is sealed_0.class_1) return
                when (x_19) {
            is sealed_0.class_2 -> {
                Unit
            }
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_42, reified T_43 : Throwable, T_53 : Cloneable, reified T_69, reified T_88> fun_17(block_14: () -> Unit, cond_6: Boolean, noinline block_16: () -> Unit, x_14: sealed_0): Unit {
...
block_14()
        ...
        block_16()
        if (x_14 is sealed_0.class_1) return
                when (x_14) {
            is sealed_0.class_2 -> {
                Unit
            }
        }
                val var_119: Boolean = (var_5 is T_88)
    }
}
typealias Alias_alias_0 = List<Map<String, Int>>
@OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
inline fun <T_20, reified T_24, reified T_27, reified T_28 : Throwable, reified T_55, reified T_83> fun_2(cond_3: Boolean, noinline block_6: () -> Unit, noinline block_28: () -> Unit, x_11: sealed_0): Unit {
...
val _catch_cls = T_28::class.java
    ...
    if (x_11 is sealed_0.class_1) return
        ...
        val var_114: Boolean = (42 is T_83)
}
typealias Alias_alias_1 = Map<String, List<Int>>
@OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
inline fun <T_86, reified T_89, reified T_90 : Throwable> fun_5(x_20: sealed_0, cond_15: Boolean, noinline block_38: () -> Unit): Unit {
    kotlin.contracts.contract { cond_15.holdsIn<Unit>(block_38) }
        try {
        val var_21: () -> Int = {             try {
...
(""+"")
    ...
    if (x_20 is sealed_0.class_1) return
        when (x_20) {
        is sealed_0.class_2 -> {
            Unit
        }
    }
        val var_120: Class<T_90> = T_90::class.java
        val var_121: Boolean = run { val _any_T_90: Any = 42; _any_T_90 is T_90 }
        val var_122: List<T_90> = listOf<T_90>()
        try {
        val var_123: T_90? = null
    } catch (e: T_90) {
val _catch_cls = T_90::class.java
    }
    block_38()
}
...
fun fun_9(x_8: sealed_0): Unit {
    ...
    if (x_8 is sealed_0.class_1) return
        ...
        val var_111: () -> Unit = {         val var_124: Int? = null
        try {
        } catch (e: RuntimeException) {
        }
    }
...
block_9()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_72 : Throwable, reified T_82, reified T_85> fun_19(noinline block_30: () -> Unit, cond_13: Boolean, noinline block_34: () -> Unit, x_17: sealed_0): Unit {
...
block_30()
        ...
        block_34()
        if (x_17 is sealed_0.class_1) return
                when (x_17) {
            is sealed_0.class_2 -> {
                Unit
            }
...
class class_6<T_35 : sealed_0, T_46 : Comparable<T_46>, T_61 : Comparable<T_61>, T_92 : Comparable<T_92>>(val shape: T_35) {
    val var_76: Any?
        field = null as T_35?
    val var_77: Boolean
        get() {
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    inline fun <reified T_47 : Throwable, T_62 : Comparable<T_62>, reified T_87> fun_20(block_18: () -> Unit, cond_7: Boolean, noinline block_21: () -> Unit, x_6: sealed_0): Unit {
...
typealias MySet_alias_3<T> = Set<T>