...
block_3()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_42, reified T_43 : Throwable> fun_17(block_14: () -> Unit, cond_6: Boolean, noinline block_16: () -> Unit): Unit {
...
class class_6<T_35 : sealed_0, T_46 : Comparable<T_46>>(val shape: T_35) {
    ...
    inline fun <reified T_47 : Throwable> fun_20(block_18: () -> Unit): Unit {
                try {
block_18()
        } catch (e: T_47) {
