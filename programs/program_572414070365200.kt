...
(false||false)
    ...
    operator fun <T_1 : Comparable<T_1>, T_4 : java.io.Serializable, T_6, T_8 : java.io.Serializable, T_10 : java.io.Serializable, T_16 : Cloneable, T_45> minus(other: class_0<T_7, T_18, T_40>): Int {
                val var_3: () -> Int = {             try {
            } catch (e: IllegalArgumentException) {
            }
