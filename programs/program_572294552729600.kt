...
val _catch_cls = T_14::class.java
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <T_11 : Runnable, reified T_12, reified T_17 : Throwable, T_21 : Runnable> fun_6(cond_1: Boolean, noinline block_3: () -> Unit): Unit {
...
inline fun <T_20, reified T_24> fun_2(): Unit {
        try {
    } catch (e: IllegalArgumentException) {
    }
