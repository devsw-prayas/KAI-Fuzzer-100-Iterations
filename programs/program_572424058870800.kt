class class_0<T_7 : Comparable<T_7>, T_18 : Comparable<T_18>, T_40 : Comparable<T_40>> {
    fun <T_19, T_34 : java.io.Serializable> fun_0(): Unit {
                try {
            var var_0: Int = 100
            val var_1: () -> Int = {                 try {
...
(false||false)
    ...
    operator fun <T_1 : Comparable<T_1>, T_4 : java.io.Serializable, T_6, T_8 : java.io.Serializable, T_10 : java.io.Serializable, T_16 : Cloneable, T_45, T_58> minus(other: class_0<T_7, T_18, T_40>): Int {
                val var_3: () -> Int = {             try {
            } catch (e: IllegalArgumentException) {
            }
...
(0-51)
    ...
    inline fun <reified T_0 : Throwable, reified T_2, reified T_3, reified T_5, T_9 : Cloneable, reified T_15, reified T_22, reified T_59> fun_3(block_0: () -> Unit, cond_0: Boolean, noinline block_1: () -> Unit, crossinline block_2: () -> Unit, crossinline block_5: () -> Unit): Unit {
...
block_0()
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_13, reified T_14 : Throwable, reified T_23, T_25 : Runnable> fun_4(cond_2: Boolean, noinline block_4: () -> Unit, noinline block_15: () -> Unit): Unit {
...
val _catch_cls = T_14::class.java
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <T_11 : Runnable, reified T_12, reified T_17 : Throwable, T_21 : Runnable, T_26 : Comparable<T_26>, T_52 : Comparable<T_52>> fun_6(cond_1: Boolean, noinline block_3: () -> Unit, crossinline block_10: () -> Unit): Unit {
...
block_3()
    ...
    suspend fun <T_31 : Comparable<T_31>, T_41 : java.io.Serializable> fun_7(): Unit {

    }
    suspend fun <T_50 : Cloneable> fun_8(): Unit {
                try {
        } catch (e: RuntimeException) {
        }
    }
    suspend fun fun_14(): Unit {

    }
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    suspend inline fun <reified T_42, reified T_43 : Throwable, T_53 : Cloneable> fun_17(block_14: () -> Unit, cond_6: Boolean, noinline block_16: () -> Unit): Unit {
...
@OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
inline fun <T_20, reified T_24, reified T_27, reified T_28 : Throwable, reified T_55> fun_2(cond_3: Boolean, noinline block_6: () -> Unit): Unit {
...
class class_3<T_29 : sealed_0>(val value: T_29) {
    val var_54: Any?
        field = null as T_29?
    val var_55: Boolean
        get() {
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    inline fun <reified T_39 : Throwable, reified T_44, T_48 : Runnable> fun_15(block_9: () -> Unit, cond_4: Boolean, noinline block_12: () -> Unit): Unit {
...
class class_6<T_35 : sealed_0, T_46 : Comparable<T_46>>(val shape: T_35) {
    val var_76: Any?
        field = null as T_35?
    val var_77: Boolean
        get() {
    ...
    @OptIn(kotlin.contracts.ExperimentalContracts::class, kotlin.contracts.ExperimentalExtendedContracts::class)
    inline fun <reified T_47 : Throwable> fun_20(block_18: () -> Unit, cond_7: Boolean, noinline block_21: () -> Unit): Unit {
