class class_0<T_7 : Comparable<T_7>, T_18 : Comparable<T_18>> {
...
(false||false)
    ...
    operator fun <T_1 : Comparable<T_1>, T_4 : java.io.Serializable, T_6, T_8 : java.io.Serializable, T_10 : java.io.Serializable, T_16 : Cloneable> minus(other: class_0<T_7, T_18>): Int {
                val var_3: () -> Int = {             try {
            } catch (e: IllegalArgumentException) {
            }
...
block_3()
    ...
    suspend fun <T_31 : Comparable<T_31>> fun_7(): Unit {
